...
class WTConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=5, stride=1, bias=True, wt_levels=1, wt_type='db5'):
...
if __name__ == '__main__':
    block = WTConv2d(in_channels=3, out_channels=3,kernel_size=3,wt_levels=3)
